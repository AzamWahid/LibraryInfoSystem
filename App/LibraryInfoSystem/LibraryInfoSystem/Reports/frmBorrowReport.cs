...
namespace LibraryInfoSystem
{
    public partial class frmBorrowReport : Form
    {
        ...
        public frmBorrowReport(ClsLogin login)
        {
            InitializeComponent();
            this.login = login;
        }
        ...
        private void setGrid()
        {
            ...
            dgvList.Columns["DaysLeft"].HeaderText = "Days Left";
            dgvList.Columns["DaysLeft"].Width = 45;
            dgvList.Columns["DaysLeft"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dgvList.Columns["DaysLeft"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private void tbSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else
            {
                var filteredList = BorrowList.Where(borrow =>
                    ...
                    borrow.DaysLeft.ToString().Contains(searchTerm) ||
